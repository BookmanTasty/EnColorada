...
$getTag = "SELECT * FROM `fichas` WHERE MATCH (`nombre`,`desc`,`desc2`,`tags`,`tags1`) AGAINST ('$tag' IN NATURAL LANGUAGE MODE)";
$run_pro = mysqli_query($con, $getTag);
$row_pro = mysqli_fetch_array($run_pro);

$idfichas = $row_pro['idfichas'];
if ($idfichas == null) {
    header('Location: 404.php'); // hacer una que diga no se encontraron coinsidencias//
}
?>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center" style="padding: 10px;" >
                ...
                <?php
                echo "<h1>Buscar $tag en Colorada</h1>";
